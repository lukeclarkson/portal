...
import icoStaffAdd from '@material-ui/icons/PersonAddSharp';
import icoStaffEdit from '@material-ui/icons/EditSharp';
import icoStaffDelete from '@material-ui/icons/DeleteSharp';
            ...
            <Paper>
                <MaterialTable
                    ...
                    columns={[
                        ...
                        { title: 'Gender', field: 'gender', lookup: { male: 'male', female: 'female' }, filterPlaceholder: 'Select' },
                    ...
                    actions={[
                      ...
                      },
                      {
                        ...
                        color: "#ee434b",
                        onClick: (event, rowData) => history.push("/staff/Edit/"+rowData.id)
                      },
                      // rowData => ({
                      //   icon: icoStaffDelete,
                    ...
                    editable={{
                      onRowDelete: oldData =>
                        new Promise((resolve, reject) => {
                          ...
                          httpBase().delete('users/'+oldData.id)
                            .then((response) => {
                              setsbMsg('Staff member deleted successfully.');
                              setsbVar('success');
                              setOpen(true);
                            ...
                            .catch((error) => {
                              setsbMsg('Sorry, there is any problem while deleting staff member.');
                              setsbVar('error');
                              setOpen(true);
                              reject()
                            });
                    ...
                    localization= {{
                      body:{
                        editRow:{
                          deleteText : 'Are you sure you want to delete this staff member?'
                        }
                      }
                    }}
                />
